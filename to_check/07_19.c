...
getInstructions( int instArr[] )
{
   ...
   for (instNumber = 0; instNumber < SIZE; instNumber += 1)
   {
      ...
      do {
         ...
         scanf("%i", &instCode);
      } while ( ( ( instCode < -9999 ) || ( instCode > 9999 ) ) && ( instCode != -99999) );
...
void
dump( int arr[], int acc, int iC, int iR, int oC, int o )
{
   int i;
...
void
splitIR( int instructionRegister, int *oC, int *o)
{
